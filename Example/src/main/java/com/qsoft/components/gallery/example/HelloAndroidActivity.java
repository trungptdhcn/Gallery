...
public class HelloAndroidActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        images.add(new Image("https://lh5.googleusercontent.com/-7qZeDtRKFKc/URquWZT1gOI/AAAAAAAAAbs/hqWgteyNXsg/s1024/Another%252520Rockaway%252520Sunset.jpg", true));
        images.add(new Image("https://lh4.googleusercontent.com/--dq8niRp7W4/URquVgmXvgI/AAAAAAAAAbs/-gnuLQfNnBA/s1024/A%252520Song%252520of%252520Ice%252520and%2525" +
                "20Fire.jpg", true));
        images.add(new Image("https://lh4.googleusercontent.com/--dq8niRp7W4/URquVgmXvgI/AAAAAAAAAbs/-gnuLQfNnBA/s1024/A%252520Song%252520of%252520Ice%252520and%2525" +
                "20Fire.jpg", true));
        images.add(new Image("https://lh6.googleusercontent.com/-8HO-4vIFnlw/URq" +
                "uZnsFgtI/AAAAAAAAAbs/WT8jViTF7vw/s1024/Antelope%252520Hallway.jpg", true));
        images.add(new Image("https://lh4.googleusercontent.com/-WIuWgVcU3Qw" +
                "/URqubRVcj4I/AAAAAAAAAbs/YvbwgGjwdIQ/s1024/Antelope%252520Walls.jpg", true));
        images.add(new Image("https://lh3.googleusercontent.com/-s-AFpvgS" +
                "eew/URquc6dF-JI/AAAAAAAAAbs/Mt3xNGRUd68/s1024/Backlit%252520Cloud.jpg", true));
        images.add(new Image("https://lh5.googleusercontent.com/-bvmif9a9" +
                "YOQ/URquea3heHI/AAAAAAAAAbs/rcr6wyeQtAo/s1024/Bee%252520and%252520Flower.jpg",true));
        images.add(new Image("https://lh5.googleusercontent.com/-n7" +
                "mdm7I7FGs/URqueT_BT-I/AAAAAAAAAbs/9MYmXlmpSAo/s1024/Bonzai%252520Rock%252520Sunset.jpg",true));
        images.add(new Image("https://lh6.googleusercontent.com/-4" +
                "CN4X4t0M1k/URqufPozWzI/AAAAAAAAAbs/8wK41lg1KPs/s1024/Caterpillar.jpg", true));
        images.add(new Image("https://lh3.googleusercontent.com/" +
                "-rrFnVC8xQEg/URqufdrLBaI/AAAAAAAAAbs/s69WYy_fl1E/s1024/Chess.jpg", true));
        images.add(new Image("https://lh5.googleusercontent.com/" +
        ...
        adapter = new DISSlideShowAdapter(this,images);
